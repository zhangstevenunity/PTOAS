...
def main():
    ...
    src1 = float_values(generator, meta.elem_counts[src1_name], style='nonzero_signed' if 'Rowexpandmul/rowexpandmul_golden.py' == 'Rowexpanddiv/rowexpanddiv_golden.py' else 'signed')

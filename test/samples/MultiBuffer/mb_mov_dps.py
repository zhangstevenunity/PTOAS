...
if __name__ == "__main__":
    print(
        dedent(
            """
            module {
              func.func @mb_mov_dps(%arg0: memref<32x32xf16, #pto.address_space<gm>>,
                ...
                scf.for %iv = %c0 to %c2 step %c1 {
                  ...
                  pto.mov_dps ins(%arg0 : memref<32x32xf16, #pto.address_space<gm>>)
                              outs(%ub : memref<32x32xf16, #pto.address_space<vec>>)
                  pto.mov_dps ins(%ub : memref<32x32xf16, #pto.address_space<vec>>)

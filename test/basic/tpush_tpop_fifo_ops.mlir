...
module {
  func.func @fifo_ops(
    ...
    %fifo = pto.initialize_pipe {dir_mask = 1, slot_size = 1024}
      (%gm_slot_buffer : memref<64x128xf32, #pto.address_space<gm>>,
       %c2v_consumer_buf : i32,
       %v2c_consumer_buf : i32)
    ...
    pto.section.cube {
      pto.tpush(%cube_tile, %fifo : memref<64x128xf32, #pto.address_space<mat>>, !pto.fifo<memref<64x128xf32, #pto.address_space<mat>>, memref<32x128xf32, #pto.address_space<vec>>, #pto.fifo_location<gm>, 2, 2>)
    }

    pto.section.vector {
      pto.tpop(%vec_tile, %fifo : memref<32x128xf32, #pto.address_space<vec>>, !pto.fifo<memref<64x128xf32, #pto.address_space<mat>>, memref<32x128xf32, #pto.address_space<vec>>, #pto.fifo_location<gm>, 2, 2>)
    }
...
// CHECK: __global__ AICORE void fifo_ops
// CHECK: TPipe<

...
//
// tpop with no subsequent tile reads — tfree should be inserted right after tpop.

module {
  func.func @tfree_no_uses(
    ...
    pto.section.vector {
      // tpop but tile is never used after — tfree right after

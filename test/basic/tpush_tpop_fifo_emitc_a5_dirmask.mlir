...
module {
  func.func @pipe_emitc_a5_dirmask(
    ...
    pto.section.cube {
      pto.tpush(%cube_tile, %pipe_c2v : memref<64x128xf32, #pto.address_space<mat>>, !pto.pipe<memref<64x128xf32, #pto.address_space<mat>>, memref<32x128xf32, #pto.address_space<vec>>>)
    ...
    pto.section.vector {
      pto.tpop(%vec_tile, %pipe_c2v : memref<32x128xf32, #pto.address_space<vec>>, !pto.pipe<memref<64x128xf32, #pto.address_space<mat>>, memref<32x128xf32, #pto.address_space<vec>>>)
